...
from read_input_r import get_non_prog_files_r,get_prog_files_r

prog_files = get_prog_files_r()
non_prog_files = get_non_prog_files_r()
...
#------------------------- Feature extraction ----------------------------------------------------
file = open('valid_artist.csv', 'w', newline='')
...
#            to_append += f' {np.mean(e)}'
        ...
        file = open('valid_artist.csv', 'a', newline='', encoding='utf-8')
        with file:
            writer = csv.writer(file)
